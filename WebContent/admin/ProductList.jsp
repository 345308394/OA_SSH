								...
								<div class="carousel-inner">
									...
									<div class="item active">
										...
										<table class="table table-condensed" style="margin-top: -38px;">
											...
											<tbody>
												 <s:iterator value="#session.productList" status="st" id="productList">
										            <tr>
										                <td><s:property value="#productList.id" /></td>
										                <td><s:property value="#productList.ProductName" /></td>
										                <td><s:property value="#productList.ProductType" /></td>
										                <td><s:property value="#productList.ProductNum" /></td>
										                <td><s:property value="#productList.MarketPrice" /></td>
										                <td><s:property value="#productList.WebPrice" /></td>
										                <td><s:property value="#productList.ProductDec" /></td>
										                <td><s:property value="#productList.pubTime" /></td>
										                <td><s:property value="#productList.ProductOn" /></td>
										                <td>
